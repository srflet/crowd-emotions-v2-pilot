      ...
      return (
        <div>
          ...
          <div className="title">
            ...
            <p>
              <i>
                A bell will ring 2 minutes, 1 minute, and 10 seconds before the
                start
              </i>
            </p>
            ...
            <fieldset>
              ...
              <p>
                <strong>
                  Please make sure to return to this tab at the end of the
                  timer. The study will start at exactly{" "}
                  {timeToStart.toLocaleTimeString()}.
                </strong>
              </p>
              <p>This study involves groups of 10 participants.</p>
              <p>
                You will be given instructions before joining 9 other players in
                the lobby.
              </p>
              <p>
                The study lasts {introInfo.time}mins and pays between $
                {introInfo.flatPay} and ${introInfo.bonusPay} depending on your
                performance.
              </p>
            </fieldset>
            ...
            {prolificCode && (
              <fieldset>
                ...
                <p>
                  You can enter this code in the study so that you can do other
                  studies before this one starts: {prolificCode}
                </p>
                <p>
                  <strong>
                    If you do not complete this study, we will ask you to return
                    your participation (this has no adverse effect on Prolific
                    status).
                  </strong>
                </p>
                <p>
                  If you do not return your participation we will have to reject
                  your participation.
                </p>
                <p>
                  If there aren't enough players to form a group, you will not
                  have to complete the study. We will pay you £0.10 for your
                  time, but you will still have to return your study.
                </p>
              </fieldset>
            )}
          </div>
    ...
    if (difference / 1000 < -1800) {
      return (
        <div>
          <p>
            <strong>
              Thank you for coming. The experiment already started.
            </strong>
          </p>
          {prolificCode && (
            <p>
              Please return your participation on Prolific (this has no adverse
              effects on your Prolific rating).
            </p>
          )}
        </div>
      )
...
class Countdown extends Component {
  ...
  componentDidMount() {
    setInterval(() => {
      let difference =
        +this.props.timeToStart - +new Date(TimeSync.serverTime(null, 1000))
  ...
  render() {
    ...
    return <p style={countdownStyle}>{`${hours}:${minutes}:${seconds}`}</p>
  }
}
