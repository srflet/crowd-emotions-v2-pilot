    ...
    render() {
        ...
        return (
            <div>
                ...
                <p className="title">You can cut your break short by pressing the continue button. {game.treatment.playerCount > 1 && "Every player as to press 'continue' for the break to end early."}</p>
                {
